...
My homelab, setup with [Terraform](https://www.terraform.io/) and [Ansible](https://www.ansible.com/), and running all my workloads via [ArgoCD](https://argoproj.github.io/cd/) on my [k3s](https://k3s.io/) cluster.
